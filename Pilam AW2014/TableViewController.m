...
- (void)viewDidLoad
{
    ...
    NSURL *blogURL = [NSURL URLWithString:@"http://nickmacioce.com/scheduleData.json"];
    ...
    for (NSDictionary *slDictionary in showListArray) {
        ...
        showPost.withGuests = [slDictionary objectForKey:@"mainContact"];
    ...
    self.navigationController.navigationBar.barTintColor = [UIColor colorWithRed:(140/255.0) green:(0/255.0) blue:(245/255.0) alpha:1];
    [self.navigationController.navigationBar setTitleTextAttributes:@{NSForegroundColorAttributeName : [UIColor colorWithRed:(255/255.0) green:(180/255.0) blue:(0/255.0) alpha:1]}];
